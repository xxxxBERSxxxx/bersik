  ...
  const trainers = [
    {
      ...
      phone: "+7 (903) 874-18-98",
      phoneRaw: "+79038741898",
    ...
    },
    {
      ...
      phone: "+7 (999) 606-26-16",
      phoneRaw: "+79996062616",
        ...
        <div className={styles.trainersGrid}>
          {trainers.map((trainer, index) => (
            <div key={index} className={`${styles.trainerCard} ${styles[trainer.gradient]}`}>
              ...
              {/* Телефон */}
              <a 
                href={`tel:${trainer.phoneRaw}`}
                className={styles.contactPhone}
              >
                <span className={styles.phoneIcon}>📞</span>
                <div className={styles.phoneInfo}>
                  <span className={styles.phoneLabel}>Телефон</span>
                  <span className={styles.phoneValue}>{trainer.phone}</span>
                </div>
                <span className={styles.phoneArrow}>→</span>
              </a>
